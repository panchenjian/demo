	...
	<view class="wu-number-box">
		...
		<slot name="input">
			<input :disabled="disabledInput || disabled" :cursor-spacing="getCursorSpacing"
				...
				class="wu-number-box__input" @blur="onBlur" @focus="onFocus" @input="onInput" type="number"
				:style="[inputStyle]" />
		</slot>
...
<style lang="scss" scoped>
	...
	$wu-numberBox-hover-bgColor: #E6E6E6 !default;
	$wu-numberBox-disabled-color: #c8c9cc !default;
	$wu-numberBox-disabled-bgColor: #f7f8fa !default;
	$wu-numberBox-plus-radius: 4px !default;
	$wu-numberBox-minus-radius: 4px !default;
	$wu-numberBox-input-text-align: center !default;
	$wu-numberBox-input-font-size: 15px !default;
	$wu-numberBox-input-padding: 0 !default;
	$wu-numberBox-input-margin: 0 2px !default;
	$wu-numberBox-input-disabled-color: #c8c9cc !default;
	$wu-numberBox-input-disabled-bgColor: #f2f3f5 !default;
	...
	.wu-number-box {
		...
		&__minus {
			...
			&--hover {
				background-color: $wu-numberBox-hover-bgColor !important;
			}

			&--disabled {
				color: $wu-numberBox-disabled-color;
				background-color: $wu-numberBox-disabled-bgColor;
			}
		}

		&__plus {
			border-top-right-radius: $wu-numberBox-plus-radius;
			border-bottom-right-radius: $wu-numberBox-plus-radius;
		}

		&__minus {
			border-top-left-radius: $wu-numberBox-minus-radius;
			border-bottom-left-radius: $wu-numberBox-minus-radius;
		}

		&__input {
			position: relative;
			text-align: $wu-numberBox-input-text-align;
			font-size: $wu-numberBox-input-font-size;
			padding: $wu-numberBox-input-padding;
			margin: $wu-numberBox-input-margin;
			@include flex;
			align-items: center;
			justify-content: center;

			&--disabled {
				color: $wu-numberBox-input-disabled-color;
				background-color: $wu-numberBox-input-disabled-bgColor;
			}
		}
	}
</style>